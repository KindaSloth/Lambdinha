...
/* package stlc-0.1.0.0 */
#ifndef VERSION_stlc
#define VERSION_stlc "0.1.0.0"
#endif /* VERSION_stlc */
#ifndef MIN_VERSION_stlc
#define MIN_VERSION_stlc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_stlc */
...
#define CURRENT_COMPONENT_ID "stlc-0.1.0.0-inplace-stlc"
